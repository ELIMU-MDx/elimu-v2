...
return [
     ...
     */
    'mail_to' => "silvan+elimu-support@kbuhl.ch",
    ...
    'classes' => [
        ...
        'bubble' => 'hidden sm:block | bg-indigo-600 active:bg-indigo-600 hover:bg-indigo-700 rounded-full shadow-lg w-14 h-14 text-white p-4',
        'input' => 'bg-gray-100 border border-gray-200 w-full max-w-full p-2 rounded-sm shadow-input text-gray-800 text-base',
        'button' => 'inline-flex place-center px-4 py-3 h-10 border-0 bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-700 overflow-hidden rounded-sm text-white leading-none no-underline',
    ],
