<x-app-layout>
    <x-slot name="header">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <h1 class="text-2xl font-semibold text-gray-900">Create a new assay</h1>
        </div>
    </x-slot>
    <div class="py-12">
        <div>
                ...
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            General information about the assay, helps other user to identify it
                        </p>
                    </div>
                </div>
                        ...
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <x-input name="name" class="mt-1" required/>
                                    <x-error field="name"/>
                                </div>
                            </div>
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-4">
                                    <label for="targets" class="block text-sm font-medium text-gray-700">Targets</label>
                                    <x-input name="targets" class="mt-1" required/>
                                    <x-error field="targets"/>
                                    <p class="mt-2 text-sm text-gray-500">
                                        Targets seperated by comma
                                    </p>
                                </div>
                            </div>
        ...
        <div class="mt-10 sm:mt-0">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">PFvarts Parameters</h3>
                        <p class="mt-1 text-sm text-gray-600">
                            Parameters for target PFvarts
                        </p>
                    </div>
                </div>
                <div class="mt-5 md:mt-0 md:col-span-2">
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6 space-y-6">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-2">
                                        <label for="email-address" class="block text-sm font-medium text-gray-700">Required
                                            repetitions</label>
                                        <x-input name="required_repetitions" type="number" class="mt-1"/>
                                    </div>
                                </div>
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-2">
                                        <label for="first-name"
                                               class="block text-sm font-medium text-gray-700">Cutoff</label>
                                        <x-input name="required_repetitions" type="number" class="mt-1"/>
                                    ...
                                    <div class="col-span-6 sm:col-span-2">
                                        <label for="last-name" class="block text-sm font-medium text-gray-700">Standard
                                            deviation cutoff</label>
