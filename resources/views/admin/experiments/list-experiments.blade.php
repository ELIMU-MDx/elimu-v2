                ...
                <div class="relative inline-block text-left" x-data="{open: false, sort: @entangle('sort')}" wire:>
                    <div>
                        ...
                        >
                            ...
                            <svg
                                class="-mr-1 ml-1 h-5 w-5 flex-shrink-0 text-indigo-600 group-hover:text-gray-500 transition-all duration-200"
                                :class="{
                                 'rotate-180': open
                                 }"
                    ...
                    <div
                        ...
                        <div class="py-1" role="none">
                            ...
                            <a
                                ...
                                href="#" class="hover:bg-gray-100 text-gray-500 block px-4 py-2 text-sm" role="menuitem"
                                tabindex="-1"
