<div>
    ...
    <x-form-section submit="createApiToken">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-input name="name" id="name" type="text" class="mt-1 block w-full" wire:model.defer="createApiTokenForm.name" autofocus />
    ...
    <x-dialog-modal wire:model="displayingToken">
        ...
        <x-slot name="content">
            ...
            <x-input name="plainTextToken" x-ref="plaintextToken" type="text" readonly :value="$plainTextToken"
