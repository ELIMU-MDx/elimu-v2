                ...
                <div class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
                    <div class="text-center">
                        ...
                        <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                            <strong class="font-bold">ELIMU-MDx</strong> (<strong class="font-bold">E</strong>lectronic
                            <strong class="font-bold">L</strong>aboratory <strong class="font-bold">I</strong>nformation & <strong class="font-bold">M</strong>anagement
                            <strong class="font-bold">U</strong>tensil for <strong class="font-bold">M</strong>olecular <strong class="font-bold">D</strong>iagnostics)
