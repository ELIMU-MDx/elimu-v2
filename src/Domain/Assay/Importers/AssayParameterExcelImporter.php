...
final class AssayParameterExcelImporter implements ToModel, WithValidation, WithHeadingRow
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cutoff_standard_deviation' => ['nullable', 'numeric', new DecimalValidationRule(8, 2)],
            'coefficient_of_variation_cutoff' => ['nullable', 'numeric', new DecimalValidationRule(8, 2)],
